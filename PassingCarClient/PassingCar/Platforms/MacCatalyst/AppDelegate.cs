...
public class AppDelegate : MauiUIApplicationDelegate
{
    ...
    {
        // Set up MacCatalyst-specific exception handling
    ...
    private void OnMarshalObjectiveCException(object sender, MarshalObjectiveCExceptionEventArgs args)
    {
        try
        {
            ...
            // Log MacCatalyst-specific exception details
            System.Diagnostics.Debug.WriteLine($"[MACCATALYST EXCEPTION] Objective-C Exception: {exception.Message}");
            System.Diagnostics.Debug.WriteLine($"[MACCATALYST EXCEPTION] Stack Trace: {exception.StackTrace}");
            
            // Log to macOS console
            Foundation.NSLog($"PassingCar MacCatalyst Exception: {exception.Message}");
        ...
        catch
        {
            ...
            Foundation.NSLog("Critical error in MacCatalyst exception handler");
        }
    }

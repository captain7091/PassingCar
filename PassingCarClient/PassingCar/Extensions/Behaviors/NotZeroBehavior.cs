...
{
    public class NotZeroBehavior : Behavior<Entry>
    {
        private const string expression = @"^[1-9]\d*$";
        ...
        {
            IsValid = !string.IsNullOrEmpty(e.NewTextValue) && Regex.IsMatch(e.NewTextValue, expression, RegexOptions.IgnoreCase, TimeSpan.FromMilliseconds(250));
